...
Below is a summary of the library methods. Most method names are self explaining and the rest are commented:
  ...
  not_authenticated # handle access denied due to being logged out
  ...
  # oauth
  auth_at_provider(provider)
  login_from_access_token(provider)
  get_user_hash(provider)
  create_from_provider!(provider)
  User.load_from_provider(provider,uid)
