      ...
      module External
        ...
        module InstanceMethods
          ...
          def add_provider_to_user(provider_name)
            ...
            unless (current_user.send(config.authentications_class.name.underscore.pluralize).send(:where, { config.provider_attribute_name.to_sym => provider_name, config.provider_uid_attribute_name.to_sym => @user_hash[:uid].to_s } )).first
