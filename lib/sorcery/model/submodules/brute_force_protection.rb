      ...
      module BruteForceProtection
        ...
        module InstanceMethods
          ...
          def lock!
            ...
            attributes[config.unlock_token_attribute_name] = TemporaryToken.generate_random_token unless config.unlock_token_mailer_disabled or config.unlock_token_mailer.nil?
            # TODO: using update_many_attributes with master should look something like this:
